...
const styles = {
  container: { maxWidth: 1100, margin: "0 auto", padding: "32px 24px 48px" },
  ...
  docName: { fontWeight: 600, fontSize: 14.5, color: "#0f172a" },
  docMeta: { fontSize: 12.5, color: "#71717a", marginTop: 5 },
  chapterBlock: { marginBottom: 14 },
  chapterTitle: {
    fontWeight: 600,
    fontSize: 14.5,
    color: "#0f172a",
  ...
  enName: { color: "#9ca3af", fontSize: 12 },
